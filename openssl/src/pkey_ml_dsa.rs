...
#[cfg(ossl350)]
use crate::pkey::{HasPublic, KeyType, PKey};
#[cfg(ossl350)]
...
impl Variant {
    ...
    #[cfg(ossl350)]
    pub(crate) fn as_key_type(&self) -> KeyType {
        match self {
            Variant::MlDsa44 => KeyType::ML_DSA_44,
            Variant::MlDsa65 => KeyType::ML_DSA_65,
            Variant::MlDsa87 => KeyType::ML_DSA_87,
        }
    }
...
pub fn new_from_seed(variant: Variant, seed: &[u8]) -> Result<PKey<Private>, ErrorStack> {
    PKey::private_key_from_seed(None, variant.as_key_type(), None, seed)
}

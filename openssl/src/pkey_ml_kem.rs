...
impl Variant {
    ...
    #[cfg(ossl350)]
    pub(crate) fn as_key_type(&self) -> crate::pkey::KeyType {
        match self {
            Variant::MlKem512 => crate::pkey::KeyType::ML_KEM_512,
            Variant::MlKem768 => crate::pkey::KeyType::ML_KEM_768,
            Variant::MlKem1024 => crate::pkey::KeyType::ML_KEM_1024,
        }
    }
...
mod tests {
    ...
    fn test_generate(variant: Variant) {
        ...
        let key_pub = PKey::public_key_from_raw_bytes_ex(
            None,
            variant.as_key_type(),
            None,
        ...
        let key_priv = PKey::private_key_from_raw_bytes_ex(
            None,
            variant.as_key_type(),
            None,
